...
describe "Browse Dashboard", :type => :feature do
  ...
  it "should allow you to search your files, remove constraints, and browse your files using facets" do
    visit "/dashboard"
    fill_in "q", with: "PDF"
  ...
  context "within my files page" do
    ...
    it "should display all the necessary information and refresh the page" do
    ...
    it "should allow me to edit files individually and in batches" do
      fill_in "q", with: "Wav"
      click_button "search-submit-header"
      click_button "Select an action"
